            ...
            <div className="rounded-2xl p-8 shadow-2xl"
              ...
              <div className="text-center mb-8">
                ...
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-xs text-[var(--clr-info)] tracking-widest mt-0.5">JISR</span>
                </div>
                <p className="text-sm text-[var(--clr-info)] mt-3">منصة تعلم اللغة الصينية HSK 1</p>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="relative my-4">
                  ...
                  <div className="relative flex justify-center">
                    <span className="px-3 text-xs text-[var(--clr-info)] bg-transparent">أو</span>
                  </div>
                </div>
              ...
              <p className="text-center text-xs text-[var(--clr-info)]/60 mt-6">
          ...
          >
            <div className="rounded-2xl p-8 shadow-2xl"
              ...
              <button
                ...
                className="flex items-center gap-1 text-[var(--clr-info)] text-sm mb-6 hover:text-white transition-colors">
              ...
              <div className="text-center mb-6">
                ...
                <p className="text-xs text-[var(--clr-info)] mt-1">
              ...
              <div className="space-y-4">
                {/* Name */}
                <div>
                  <label className="block text-sm text-[var(--clr-info)] mb-1.5">الاسم</label>
                  <div className="relative">
                    <User className="absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[var(--clr-info)]/50" />
                    <input
                      type="text"
                      value={name}
                      onChange={(e) => setName(e.target.value)}
                      placeholder="أدخل اسمك..."
                      className="w-full pr-10 pl-4 py-2.5 rounded-xl text-sm text-white placeholder:text-[var(--clr-info)]/40 outline-none transition-all focus:ring-2 focus:ring-[var(--clr-info)]/50/50"
                ...
                {view === 'register' && (
                  <div>
                    <label className="block text-sm text-[var(--clr-info)] mb-1.5">البريد الإلكتروني (اختياري)</label>
                    <input
                      type="email"
                      value={email}
                      onChange={(e) => setEmail(e.target.value)}
                      placeholder="example@mail.com"
                      className="w-full px-4 py-2.5 rounded-xl text-sm text-white placeholder:text-[var(--clr-info)]/40 outline-none transition-all focus:ring-2 focus:ring-[var(--clr-info)]/50/50"
                      style={{ background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.15)' }}
                      dir="ltr"
                    />
                  </div>
                ...
                {/* Password */}
                <div>
                  <label className="block text-sm text-[var(--clr-info)] mb-1.5">كلمة المرور</label>
                  <div className="relative">
                    <Lock className="absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[var(--clr-info)]/50" />
                    <input
                      type={showPassword ? 'text' : 'password'}
                      value={password}
                      onChange={(e) => setPassword(e.target.value)}
                      placeholder="••••••"
                      className="w-full pr-10 pl-10 py-2.5 rounded-xl text-sm text-white placeholder:text-[var(--clr-info)]/40 outline-none transition-all focus:ring-2 focus:ring-[var(--clr-info)]/50/50"
                      style={{ background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.15)' }}
                      dir="ltr"
                      onKeyDown={(e) => e.key === 'Enter' && (view === 'login' ? handleLogin() : handleRegister())}
                    />
                    <button
                      ...
                      className="absolute left-3 top-1/2 -translate-y-1/2 text-[var(--clr-info)]/50 hover:text-[var(--clr-info)] transition-colors">
                ...
                {error && (
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    className="p-3 rounded-xl text-sm text-[var(--clr-danger)] text-center"
