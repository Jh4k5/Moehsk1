...
values
  ...
  ('access.free_lesson_count', '2', 'number', 'access',
   'عدد الدروس المجانية', 'أول كم درساً من المستوى الأول يُفتح بلا اشتراك.', true, 20),
  ('access.free_levels', '[1]', 'json', 'access',
   'المستويات التي تحوي دروساً مجانية', 'مصفوفة أرقام. المستويان ٢ و٣ مدفوعان بالكامل.', true, 30),

  -- Trial behaviour. Off by default: the free tier is the trial.
  ('trial.enabled', 'false', 'boolean', 'trial',
   'تفعيل التجربة المجانية المؤقتة', 'حين تُطفأ يبقى المجاني هو التمهيد والدرسين.', true, 10),
  ('trial.days', '0', 'number', 'trial',
   'مدة التجربة بالأيام', 'تُحتسب من أول تسجيل دخول.', true, 20),
